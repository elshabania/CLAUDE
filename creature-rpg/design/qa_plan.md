...
|---|---|---|---|
| M-01 | — | Title → New Game → settings reachable | Audio starts only after the first input; settings persist; the default name is **Hollis** (D7) |
