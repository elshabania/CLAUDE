...
export const c20: SpeciesVisual = {
  ...
  parts: [
    ...
    { name: 'eye', parent: 'head', mirror: true, prim: { t: 'eye', r: 0.052 }, at: [0.068, 0.03, 0.095], rot: [0, 34, 0] },
    ...
    { name: 'shoulder', parent: 'body', mirror: true, prim: { t: 'none' }, at: [0.1, 0.04, 0.06], rot: [0, 18, 8], anim: ['flap'] },
    { name: 'nut', parent: 'shoulder', mirror: true, prim: { t: 'sphere', r: [0.07, 0.045, 0.055] }, at: [0.03, 0, 0], slot: 'A', mat: 'SKIN' },
    { name: 'blade', parent: 'shoulder', mirror: true, prim: { t: 'extrude', shape: 'X_samara', w: 0.62, h: 0.66, depth: 0.016 }, at: [0.02, 0, 0.0], rot: [90, 0, -90], slot: 'S', mat: 'MEMBRANE', opacity: 0.95, anim: ['fx:wings'] },
