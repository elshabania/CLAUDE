...
export const c09: SpeciesVisual = {
  ...
  parts: [
    ...
    { name: 'chest', parent: 'torso', prim: { t: 'sphere', r: [0.16, 0.27, 0.1] }, at: [0, 0.3, 0.12], rot: [-8, 0, 0], slot: 'P+' },
    { name: 'throat', parent: 'torso', prim: { t: 'sphere', r: [0.1, 0.1, 0.06] }, at: [0, 0.49, 0.1], slot: 'P+' },
    { name: 'neck', parent: 'torso', prim: { t: 'capsule', r: 0.125, len: 0.02 }, at: [0, 0.34, 0.0], rot: [16, 0, 0] },
    ...
    { name: 'head', parent: 'torso', prim: { t: 'sphere', r: [0.17, 0.1, 0.165] }, at: [0, 0.525, 0.07], anim: ['look'] },
    { name: 'ear', parent: 'head', mirror: true, prim: { t: 'sphere', r: [0.036, 0.032, 0.018] }, at: [0.14, 0.035, -0.05], rot: [0, 50, -10] },
    { name: 'muzzle', parent: 'head', prim: { t: 'sphere', r: [0.11, 0.058, 0.08] }, at: [0, -0.03, 0.125], slot: 'W' },
    ...
    { name: 'eye', parent: 'head', mirror: true, prim: { t: 'eye', r: 0.048 }, at: [0.078, 0.04, 0.128], rot: [-10, 28, 0] },
    { name: 'brow', parent: 'head', mirror: true, prim: { t: 'capsule', r: 0.011, len: 0.035 }, at: [0.085, 0.085, 0.118], rot: [-10, 28, 104], slot: 'P-' },
    // arms: thick, hanging at the sides; webbed paws (empty — never gripping shell)
    { name: 'shoulder', parent: 'torso', mirror: true, prim: { t: 'sphere', r: [0.075, 0.08, 0.085] }, at: [0.19, 0.36, 0.02] },
    { name: 'arm', parent: 'shoulder', mirror: true, prim: { t: 'capsule', r: 0.068, len: 0.12 }, at: [0.02, 0.0, 0.0], rot: [172, 0, -14], anim: ['gait:BL'] },
    { name: 'forearm', parent: 'arm', mirror: true, prim: { t: 'capsule', r: 0.062, len: 0.1 }, at: [0, 0.23, 0], rot: [-78, 0, 34] },
    { name: 'paw', parent: 'forearm', mirror: true, prim: { t: 'sphere', r: [0.075, 0.07, 0.06] }, at: [0, 0.22, 0.0] },
    { name: 'pawWeb', parent: 'paw', mirror: true, prim: { t: 'extrude', shape: 'X_fan', w: 0.15, h: 0.08, depth: 0.014 }, at: [0, 0.05, 0.0], rot: [0, 0, 0], slot: 'P+', mat: 'SKIN' },
    ...
    { name: 'tail', parent: 'pelvis', prim: { t: 'tube', pts: [[0, -0.02, -0.12], [0.1, -0.19, -0.24], [0.28, -0.265, -0.2], [0.46, -0.265, -0.2], [0.56, -0.25, -0.28], [0.53, -0.24, -0.35]], r0: 0.115, r1: 0.072 } },
    { name: 'shield', parent: 'pelvis', prim: { t: 'extrude', shape: 'X_fan', w: 2 * R, h: R, depth: 0.075 }, at: [0.52, -0.33, -0.38], rot: [0, 50, 0], slot: 'S', mat: 'SHELL', anim: ['fx:shield'] },
