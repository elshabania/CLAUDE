...
export const LOOKS: Record<string, HumanLook> = {
  ...
  tamsin: { id: 'tamsin', build: 'adult', sex: 'f', skin: '#F0D0B4', hair: '#E3B04B', hairStyle: 'tail', top: '#E7EEF2', top2: '#3D7E8C', pants: '#D6CFBd', shoes: '#2A2A30', accent: '#C4553A', iris: '#3d6e8c', extras: ['kite', 'sash', 'gloves'], wear: { outer: 'jacket', outerSleeve: 1.55, inner: 'tee', innerSleeve: 0.45, legs: 'trousers', shoe: 'sneaker', piping: '#C4553A' } },
